...
class VballNetGridV1b(nn.Module):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="VballNetGridV1b ONNX Exporter")
    ...
    print(f"VballNetGridV1b initialized with {total_params:,} parameters")
    ...
    if args.export_onnx:
        ...
        onnx_filename = os.path.splitext(args.model_path)[0] + ".onnx" if args.model_path else "vball_net_grid_v1b.onnx"
        torch.onnx.export(
            model,
            (dummy_input,),
            onnx_filename,
